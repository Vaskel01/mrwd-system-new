  ...
  return <div className="space-y-5">
    ...
    <div className="grid gap-5 lg:grid-cols-2">
      ...
      <Section title="Billing import" description="Match bills to the official account list. Customers do not need a login yet. Reimport an account and billing period to update its bill or payment status.">
        <a href="/templates/billing-statement.csv" download className="mb-3 inline-block text-sm font-bold text-brand-700 underline">Download statement CSV template</a>
        <p className="mb-3 text-xs leading-relaxed text-gray-500">Copy values from the official billing report. The template includes bill number, account details, reading date, charges, penalty, and amount after due date. amount_due means the amount on or before the due date. Leave unknown optional values blank; enter 0 only for a confirmed zero. Expanded files replace the statement details for that account and period. The original eight-column format still works.</p>
