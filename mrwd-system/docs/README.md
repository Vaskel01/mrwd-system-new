...
| Document | Purpose |
|---|---|
| `DEPLOYMENT.md` | Fresh deployment and hosting steps |
| `DATABASE.md` | One-file Supabase setup and account bootstrap |
...
Classifier datasets/evaluation artifacts are retained in this folder for development and thesis documentation.
