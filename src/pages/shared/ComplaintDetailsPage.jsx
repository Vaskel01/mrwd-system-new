      ...
      {!hasStoredAnalysis ? (
        ...
        <>
          <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3"><p className="text-[9px] font-black uppercase tracking-wider text-gray-400">Predicted Category</p><p className="mt-1 text-sm font-black text-navy-900">{complaint.classified_category || complaint.complaint_type}</p></div>
          ...
          {complaint.classification_mismatch && <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5"><p className="text-xs font-bold text-amber-900">Category mismatch detected</p><p className="mt-0.5 text-xs text-amber-700">Selected “{complaint.complaint_type},” classified as “{complaint.classified_category}.”</p></div>}
