    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} onChange={updatePreview} className="space-y-5">
        ...
        <div className="card p-5">
          ...
          {photoPreview ? (
            <div className="relative inline-block">
              <img src={photoPreview} alt="Preview" className="w-40 h-40 object-cover  border border-gray-200"/>
            ...
            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300  cursor-pointer hover:border-brand-400 hover:bg-slate-50 transition-colors">
        ...
        <button type="submit" disabled={submitting} className="btn-primary w-full flex items-center justify-center gap-2">
          {submitting
            ? <><div className="w-4 h-4 border-2 border-white border-t-transparent  animate-spin"/>Submitting...</>
            : 'Submit Complaint'
          }
        </button>
