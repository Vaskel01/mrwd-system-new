...
-- Complaint evidence is private. The bucket itself rejects oversized or unsupported
-- files; authorized API responses expose only short-lived signed URLs.
...
create policy "complaint_photos_owner_read" on storage.objects
...
-- ===== External notification delivery worker =====
begin;
