...
| `UAT_TEST_PLAN.md` | Manual end-to-end checks for Customers, Commercial Services Staff, ECMD Staff, System Supervisors, Maintenance Personnel, security, and data integrity. |
