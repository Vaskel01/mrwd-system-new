...
values
  ('No Water', 'No water supply or extended service interruption.', 40, true),
...
insert into mock_templates values
  (1, 'No Water', 'There has been no water supply in our area for two days. This is urgent because several households have no drinking water.', 'Mabini Street, Roxas City', 'Zone I', 11.5854, 122.7512, true, 'pending', 'high', 100, 40, 10, 'No Water', 64, 'urgent', false, 'matched keyword dataset', '[{"id":"KW-098","term":"for two days","match_type":"phrase","complaint_category":null,"category_weight":0,"priority_weight":12,"severity":"high","sentiment":"urgent","context":"duration"},{"id":"KW-002","term":"no water","match_type":"phrase","complaint_category":"No Water","category_weight":9,"priority_weight":18,"severity":"high","sentiment":"urgent","context":"issue"},{"id":"KW-106","term":"urgent","match_type":"word","complaint_category":null,"category_weight":0,"priority_weight":12,"severity":"high","sentiment":"urgent","context":"urgency"}]'::jsonb, '[]'::jsonb, '["Selected category base severity (+40)","Dataset terms: \"for two days, no water, urgent\" (+42)","Text classified as No Water (64% confidence)","Sentiment adjustment (urgent, +10)","Photo evidence (+10)"]'::jsonb, 'hybrid-sentiment-v1.1.0', 'Hybrid sentiment-aware dataset-backed priority scoring algorithm', null, null, null, false, null, null, null),
  ...
  (10, 'No Water', 'Water service was restored, but we are submitting this record for documentation.', 'Banica Road, Roxas City', 'Zone X', 11.5741, 122.7457, false, 'pending', 'medium', 40, 40, 0, 'No Water', 25, 'neutral', false, 'selected-category fallback', '[]'::jsonb, '[]'::jsonb, '["Selected category base severity (+40)","No dataset keyword matched; selected category used as fallback","Text classified as No Water (25% confidence)","Sentiment adjustment (neutral, +0)","No photo evidence (+0)"]'::jsonb, 'hybrid-sentiment-v1.1.0', 'Hybrid sentiment-aware dataset-backed priority scoring algorithm', null, null, 'The customer reopened the complaint because the service interruption happened again after the previous completion.', false, null, null, null);
