...
export default function ComplaintDetailsPage() {
  ...
  return <div className="space-y-5 complaint-receipt">
    ...
    {complaint.status === 'blocked' && <div className="rounded-xl border border-amber-200 bg-amber-50 p-5"><p className="font-display font-bold text-amber-900">Administrative review requested</p><p className="mt-1 text-sm text-amber-800">{complaint.reassignment_reason || complaint.unable_reason || 'Maintenance Personnel reported an issue that needs review.'}</p></div>}
