    ...
    <div className="space-y-5">
      ...
      <form onSubmit={save} className="card rounded-xl p-5 sm:p-6 space-y-5 max-w-2xl">
        ...
        {effectiveRole === 'customer' && <div className="border-t border-gray-100 pt-5 space-y-4">
          <p className="text-sm text-gray-600">Account numbers saved here are contact information only. <a href="/customer/billing" className="font-bold text-brand-700">Open Billing to link and verify your service accounts.</a></p>
