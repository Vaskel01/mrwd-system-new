...
export default function AssignTaskPage() {
  ...
  return (
    <div>
      ...
      {/* Toast */}
      {toast && (
        <div className="mb-4 bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3 rounded-lg flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {/* Assign panel */}
          {selected && (
            <div className="mt-4 card p-4 bg-brand-50 border-brand-200">
