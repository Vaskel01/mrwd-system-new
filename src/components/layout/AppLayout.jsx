...
function adminNavigation(user) {
  ...
  add(CAPABILITIES.ECMD_DISPATCH, { section: 'WDLCD', to: '/ecmd/dispatch', icon: AssignIcon, label: 'Complaint dispatch' })
  add(CAPABILITIES.ECMD_OPERATIONS, { section: 'WDLCD', to: '/ecmd/field-operations', icon: WrenchIcon, label: 'Field operations analytics' })
  add(CAPABILITIES.ECMD_OPERATIONS, { section: 'WDLCD', to: '/ecmd/crews', icon: UsersIcon, label: 'Crew management' })
  add(CAPABILITIES.ECMD_OPERATIONS, { section: 'WDLCD', to: '/ecmd/availability', icon: CalendarIcon, label: 'Availability calendar' })
