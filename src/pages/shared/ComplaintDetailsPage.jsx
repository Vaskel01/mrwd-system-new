...
export default function ComplaintDetailsPage() {
  ...
  const handleAssign = async () => { if (!assignStaff) return; if (await run(async () => { await store.assignComplaint(id, assignStaff, assignNotes); return store.fetchComplaint(id) }, complaint?.assigned_to ? 'Complaint reassigned.' : 'Maintenance Personnel assigned.')) setAssignOpen(false) }
