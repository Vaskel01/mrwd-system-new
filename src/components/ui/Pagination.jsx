export default function Pagination({ page, pageSize, total, onPageChange, label = 'records' }) {
  ...
  return (
    <nav className="card rounded-xl px-4 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3" aria-label={`${label} pagination`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="px-3 text-xs font-bold text-gray-500" aria-live="polite">Page {safePage} of {totalPages}</span>
